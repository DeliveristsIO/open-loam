---
title: Architecture
description: How each pillar is built, the module map, the event backbone, and the decisions made in the prototype.
nav_order: 3
---
