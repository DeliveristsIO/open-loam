class CreateOpenLoamConfigs < ActiveRecord::Migration[8.1]
  def change
    create_table :open_loam_configs do |t|
      t.string :key, null: false
      # Nullable: a NULL tenant_id is the GLOBAL row; a set one is a per-tenant
      # override. So this is NOT a tenant-scoped table.
      t.references :tenant, null: true, foreign_key: { to_table: :open_loam_tenants }
