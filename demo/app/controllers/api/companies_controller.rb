module Api
  # JSON for Company. Same rules as the admin screen, same policy:
  ...
  class CompaniesController < BaseController
    ...
    def index
      ...
      records = Company.order(created_at: :desc).to_a
    ...
    def permitted_params(policy)
      params.require(:company).permit(*policy.permitted_fields(FIELDS))
    end
  end
end
