module OpenLoam
  ...
  # empty key.
  #
  # OpenLoam's tables follow the host app's key type (see
  # OpenLoam::Generators::PrimaryKeyOptions), so on a string-keyed app every OpenLoam
  ...
  # enough to reach models that had nothing to do with OpenLoam.
  #
