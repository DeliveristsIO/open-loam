...
module OpenLoam
  ...
  class Current < ActiveSupport::CurrentAttributes
    # config_cache memoizes resolved OpenLoam::Configs values for the duration of
    ...
    #
    # mutation_mode is the approval-gate seam (OpenLoam::PendingActions): nil/:direct
    ...
    # dictionary_cache memoizes resolved OpenLoam::Dictionaries lookups for one
    # request/job, keyed by [kind, key, tenant_id] — same posture as config_cache.
    # locale is the current content-translation language (OpenLoam::Translatable) —
